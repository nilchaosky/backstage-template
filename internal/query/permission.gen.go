...
func newPermission(db *gorm.DB, opts ...gen.DOOption) permission {
	...
	_permission.SnowflakeID = field.NewInt64(tableName, "id")
	...
	_permission.API = field.NewString(tableName, "api")
...
type permission struct {
	...
	Code        field.String // 权限代码，如user:create
	Title       field.String // 权限名称
	ParentID    field.Int64  // 父权限ID，0表示顶级权限
	API         field.String // API路径
