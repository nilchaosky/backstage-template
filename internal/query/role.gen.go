...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.SnowflakeID = field.NewInt64(tableName, "id")
	_role.Title = field.NewString(tableName, "title")
	_role.Code = field.NewString(tableName, "code")
	_role.IsSystem = field.NewInt32(tableName, "is_system")
	_role.StatusValue = field.NewInt32(tableName, "status")
	_role.TimestampsCreatedAt = field.NewField(tableName, "created_at")
	_role.TimestampsUpdatedAt = field.NewField(tableName, "updated_at")
	_role.OptimisticLockVersion = field.NewField(tableName, "_version")
...
type role struct {
	...
	ALL                   field.Asterisk
	SnowflakeID           field.Int64  // ID
	Title                 field.String // 角色名称
	Code                  field.String // 角色代码
	IsSystem              field.Int32  // 是否系统控制 1-是 2-否
	StatusValue           field.Int32  // 状态
	TimestampsCreatedAt   field.Field  // 创建时间
	TimestampsUpdatedAt   field.Field  // 更新时间
	OptimisticLockVersion field.Field  // 版本号
...
func (r *role) updateTableName(table string) *role {
	...
	r.SnowflakeID = field.NewInt64(table, "id")
	r.Title = field.NewString(table, "title")
	r.Code = field.NewString(table, "code")
	r.IsSystem = field.NewInt32(table, "is_system")
	r.StatusValue = field.NewInt32(table, "status")
	r.TimestampsCreatedAt = field.NewField(table, "created_at")
	r.TimestampsUpdatedAt = field.NewField(table, "updated_at")
	r.OptimisticLockVersion = field.NewField(table, "_version")
...
func (r *role) fillFieldMap() {
	...
	r.fieldMap["id"] = r.SnowflakeID
	r.fieldMap["title"] = r.Title
	r.fieldMap["code"] = r.Code
	r.fieldMap["is_system"] = r.IsSystem
	r.fieldMap["status"] = r.StatusValue
	r.fieldMap["created_at"] = r.TimestampsCreatedAt
	r.fieldMap["updated_at"] = r.TimestampsUpdatedAt
	r.fieldMap["_version"] = r.OptimisticLockVersion
}
